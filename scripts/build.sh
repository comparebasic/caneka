...
$CC -g -I ./artifact/src/include -I artifact/src/base/include -I ./artifact/src/programs/builder/include -c \
    -o ./build/libbuilder/libbuilder.a ./artifact/src/builder/builder.c -DINSECURE -DCNK_EXT && \
