...
i64 MemChapter_Print(MemCtx *m, struct strvec *v, i32 fd, Abstract *a, cls type, boolean extended);
i64 Span_Print(MemCtx *m, struct strvec *v, i32 fd, Abstract *a, cls type, boolean extended);
i64 SpanState_Print(MemCtx *m, struct strvec *v, i32 fd, Abstract *a, cls type, boolean extended);
