...
static i64 Hashed_Print(MemCtx *m, StrVec *v, i32 fd, Abstract *a, cls type, boolean extended){
...
static i64 Wrapped_Print(MemCtx *m, StrVec *v, i32 fd, Abstract *a, cls type, boolean extended){
    /*
...
static i64 WrappedUtil_Print(MemCtx *m, StrVec *v, i32 fd, Abstract *a, cls type, boolean extended){
...
static i64 WrappedI64_Print(MemCtx *m, StrVec *v, i32 fd, Abstract *a, cls type, boolean extended){
...
static i64 WrappedTime64_Print(MemCtx *m, StrVec *v, i32 fd, Abstract *a, cls type, boolean extended){
...
static i64 Abstract_Print(MemCtx *m, StrVec *v, i32 fd, Abstract *a, cls type, boolean extended){
    /*
    if(t == NULL){
        printf("u0");
    }else{
...
static i64 Single_Print(MemCtx *m, StrVec *v, i32 fd, Abstract *a, cls type, boolean extended){
    /*
    Single *v = (Single *)a;
