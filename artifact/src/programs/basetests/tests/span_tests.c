...
status Span_Tests(MemCtx *gm){
    ...
    r |= Test(s->type.of == s1->type.of, "After expand, Span item 0 has type string _c found _c", 
        Type_ToChars(s1->type.of), Type_ToChars(s->type.of));
    r |= Test(Equals(s1, s), "String 1 equals '_t' found '_t'", 
        s1, s);
    ...
    r |= Test(Equals(s512, s), "String 512 equals '_t' found '_t'", 
        s512, s);
    ...
    r |= Test(Equals(s4079, s), "String 4079 equals '_t' found '_t'", 
        s4079, s);
    ...
    r |= Test(Equals(s513, s), "String 513 equals '_t' found '_t'", 
        s513, s);
