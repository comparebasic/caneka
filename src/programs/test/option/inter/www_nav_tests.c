...
status WwwNav_Tests(MemCh *m){
    ...
    void *expected[] = {
        ...
        S(m, "bytes"), I32_Wrapped(m, 2), I16_Wrapped(m, ZERO),
        S(m, "str"), I32_Wrapped(m, 3), I16_Wrapped(m, ZERO),
        S(m, "fmt"), I32_Wrapped(m, 3), I16_Wrapped(m, MORE),
        S(m, "tos"), I32_Wrapped(m, 3), I16_Wrapped(m, ZERO),
        NULL, NULL,
    };
