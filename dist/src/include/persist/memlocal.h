...
status MemLocal_Persist(Span *tbl, Span *path, IoCtx *ctx);
Span *MemLocal_Load(MemCtx *m, Span *path, struct ioctx *ctx);
status MemLocal_Destroy(MemCtx *m, Span *path, IoCtx *ctx);
